#' Function to return the right list of administrative levels for somalia and kenya options
#'
#' @details List of administrative levels
#' @param country Country of interest
#' @return [data.frame] Dataframe of somalia or kenya
#' @export
